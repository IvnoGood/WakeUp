...
export default function AddNewAlarmScreen() {
    const colors = {
        ...
        FairyLight: 0xFFE42D, FairyLightNCC: 0xFF9D2A, Gray0: 0x000000, Gray10: 0x1A1A1A,
        Gray25: 0x404040, Gray50: 0x7F7F7F, Gray75: 0xBFBFBF, Gray100: 0xFFFFFF,
        Grey0: 0x000000, Grey10: 0x1A1A1A, Grey25: 0x404040, Grey50: 0x7F7F7F,
        Grey75: 0xBFBFBF, Grey100: 0xFFFFFF, Red1: 0xFF0000, Red2: 0xEE0000,
        Red3: 0xCD0000, Red4: 0x8B0000, Green1: 0x00FF00, Green2: 0x00EE00,
        Green3: 0x00CD00, Green4: 0x008B00, Blue1: 0x0000FF, Blue2: 0x0000EE,
        Blue3: 0x0000CD, Blue4: 0x00008B, Orange1: 0xFFA500, Orange2: 0xEE9A00,
        Orange3: 0xCD8500, Orange4: 0x8B5A00, Yellow1: 0xFFFF00, Yellow2: 0xEEEE00,
        Yellow3: 0xCDCD00, Yellow4: 0x8B8B00, Cyan1: 0x00FFFF, Cyan2: 0x00EEEE,
        Cyan3: 0x00CDCD, Cyan4: 0x008B8B, Magenta1: 0xFF00FF, Magenta2: 0xEE00EE,
        Magenta3: 0xCD00CD, Magenta4: 0x8B008B, VioletRed: 0xD02090, DeepPink1: 0xFF1493,
        DeepPink2: 0xEE1289, DeepPink3: 0xCD1076, DeepPink4: 0x8B0A50, Gold1: 0xFFD700,
        Gold2: 0xEEC900, Gold3: 0xCDAD00, Gold4: 0x8B7500
    }

    const { theme } = useAppTheme();
    const [dpcolors, setdpcolors] = useState([]);

    useEffect(() => {
        const colorList = Object.keys(colors).map((name) => ({
            name,
            color: `#${colors[name].toString(16).padStart(6, '0')}`, // always 6 digits
        }));
        setdpcolors(colorList);
    }, []);

    const handlePress = (name, color) => {
        console.log(`Clicked ${name} - ${color}`);
        // 👉 here you could navigate, select, etc.
    };
        ...
        <ScrollView style={{ backgroundColor: theme.colors.background }}>
            <View style={styles.container}>
                {dpcolors.map((elem) => (
                    <TouchableOpacity
                        key={elem.color}
                        style={[styles.box, { backgroundColor: elem.color }]}
                        onPress={() => handlePress(elem.name, elem.color)}
                    >
